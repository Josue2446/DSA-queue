...
//
// Summary: queue ADT used to keep track of user input, using a circular
//          queue in a static array
//
// Test Cases: N/A
//
// Author: Josue 
...
//
//   void print()
//     Precondition: A queue object exist
//     Postcondition: Prints a 2D representation of a cicular queue showing
//                    all elements and if the value(s) in them, if there is
//                    a value, otherwise a dash will be outputed.
//
...
namespace main_savitch_8B
{
    ...
    public:
        ...
        static const size_type CAPACITY = 8;
        // CONSTRUCTOR
        queue( );
